...
enum {
  ...
  SL_LDS_KEY_VMTI_UTC = 2,
  SL_LDS_KEY_VMTI_VERSION = 4,
  SL_LDS_KEY_VMTI_NUM_TARGETS_DETECTED = 5,
  SL_LDS_KEY_VMTI_NUM_REPORTED_TARGETS = 6,
  SL_LDS_KEY_VMTI_FRAME_WIDTH = 8,
  SL_LDS_KEY_VMTI_FRAME_HEIGHT = 9,
  SL_LDS_KEY_VMTI_VTARGET_SERIES = 101,

  SL_LDS_KEY_VTARGET_CENTROID_PIXEL = 1,
  ...
  SL_LDS_KEY_VTARGET_TARGET_CENTROID_ROW = 19,
  SL_LDS_KEY_VTARGET_TARGET_CENTROID_COL = 20,
...
/// KLV data structure 
/// ext := ST 0601.9 When UAS Datalink LS decoding systems understand the
/// distance-representation of certain metadata items the decoder shall use the distance extended
/// representation
