...
s32 SLASockClientConnect(SLASocket *sock, s32 timeout = SL_FOREVER);
...
{
  char m_buf[1024 * 16]; // Needs to match max packet size 
  s32 m_bufidx;
  s32 m_buflen;
...
protected:
  ...
  bool isAsyncronous; // true = asynchronous mode. 
#endif
};
