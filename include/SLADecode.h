...
*/
typedef  void(__cdecl *SLADecodeCB) (
...
*/
typedef  void(__cdecl *SLAStatsCB) (SLCapStats *stats, void *context);
...
public:
  ...
  */
	...
	int __cdecl Create(const char *UDPAddress, SLADecodeCB cb);
  ...
  */
  ...
  /*!
  *  Set special upsampling factor to compensate for a downsampled compressed image sent
  *  @return 0 for success, -1 for failure
  */
  int SetUpSample(
    int upSample   //!< upsample factor (1, 2, 4)
    );
  int GetUpSample( );
