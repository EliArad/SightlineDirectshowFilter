...
#ifndef s8
#ifndef _TMS320C6X
  // ARM interprets 'char' as unsigned by default.
  typedef signed char    s8;  //!< 8 bit signed integer character
#else
  typedef char           s8;  //!< 8 bit signed integer character
#endif
...
#define SLPID    3.1415926535897932384626433832795  // PI
#define SLPI_2D  1.5707963267948966192313216916398  // PI/2 
...
typedef struct {
  u16 row;    //!< Vertical offset to the upper left corner of the rectangle
  u16 col;    //!< Horizontal offset to the upper left corner of the rectangle
  u16 high;   //!< Height of the rectangle in pixels
  u16 wide;   //!< Width of the rectangle in pixels
} SLURect;
